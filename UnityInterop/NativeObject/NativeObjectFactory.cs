...
public unsafe class NativeObjectFactory
{
    ...
    bool HasGetSpriteAtlasDatabase => UnityVersion.Unity2017_1 <= version;
    bool HasGetSceneVisibilityState => UnityVersion.Unity2019_1 <= version;
    ...
    public NativeObjectFactory(UnityVersion version, SymbolResolver resolver)
    {
        ...
        if (UnityVersion.Unity3_5 <= version && version < UnityVersion.Unity2022_2)
        {
    ...
    public NativeObject GetSpriteAtlasDatabase()
        => new(s_GetSpriteAtlasDatabase(), this, PersistentTypeID.SpriteAtlasDatabase, version);

    public NativeObject GetSceneVisibilityState()
        => new(s_GetSceneVisibilityState(), this, PersistentTypeID.SceneVisibilityState, version);

    public NativeObject GetInspectorExpandedState()
        => new(s_GetInspectorExpandedState(), this, PersistentTypeID.InspectorExpandedState, version);

    public NativeObject GetAnnotationManager()
        => new(s_GetAnnotationManager(), this, PersistentTypeID.AnnotationManager, version);

    public NativeObject GetMonoManager()
        => new(s_GetMonoManager(), this, PersistentTypeID.MonoManager, version);

    public NativeObject GetTimeManager()
        => new(s_GetTimeManager(), this, PersistentTypeID.TimeManager, version);
