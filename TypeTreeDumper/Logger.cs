...
public static class Logger
{
    ...
    public static void Info(string message) => InfoLog?.Invoke(message);
    ...
    public static void Verb(string message) => VerbLog?.Invoke(message);
    ...
    public static void Error(string message) => ErrorLog?.Invoke(message);
}