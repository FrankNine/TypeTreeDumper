...
public static unsafe class EntryPoint
{
    ...
    private static ProcessModule FindProcessModule(Regex regex)
    {
    ...
    private static void ExecuteDumper()
    {
    ...
    private static void InitializePackageManager()
    {
    }

    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvThiscall)])]
    private static int ValidateDates(void* @this, void* param1)
    {
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static byte PlayerInitEngineNoGraphics(void* a, void* b)
    {
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static void AfterEverythingLoaded(void* app)
    {
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static byte AssertImplementation(int instanceID, sbyte* filePtr, int line, int column, sbyte* messagePtr)
    {
        var mono = FindProcessModule(new Regex("^mono", RegexOptions.IgnoreCase)).BaseAddress;
        var MonoStringToUTF8 = (delegate* unmanaged[Cdecl]<sbyte*, void*>)NativeLibrary.GetExport(mono, "mono_string_to_utf8");
    ...
    private static void HandleEngineInitialization()
    {
        try
        {
            AttachToParentConsole();
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)])]
    private static void FallbackLoaderCallback()
    {
        HandleEngineInitialization();
    }

    private static void InitializeFallbackLoader()
    {
