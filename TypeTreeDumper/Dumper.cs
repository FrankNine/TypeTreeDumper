...
internal static class Dumper
{
    ...
    private static void ExportRTTI(UnityInfo info)
    {
    ...
    private static void ExportStringData(CommonString strings)
    {
    ...
    private static void ExportClassesJson(UnityInfo info)
    {
    ...
    private static void ExportStructData(UnityEngine engine, string fileName, TransferInstructionFlags flags)
    {
    ...
    private static void ExportStructDump(UnityInfo info, string fileName, bool isRelease)
    {
    ...
    private static void ExportInfoJson(UnityInfo info)
    {
